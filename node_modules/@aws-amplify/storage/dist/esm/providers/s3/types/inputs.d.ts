import { StorageCopyInput, StorageDownloadDataInput, StorageGetPropertiesInput, StorageGetUrlInput, StorageListInput, StorageRemoveInput, StorageUploadDataInput } from '../../../types';
import { CopyDestinationOptions, CopySourceOptions, DownloadDataOptions, GetPropertiesOptions, GetUrlOptions, ListAllOptions, ListPaginateOptions, RemoveOptions, UploadDataOptions } from '../types';
/**
